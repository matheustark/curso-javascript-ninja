...
*/
pessoa.nomeCompleto() // 'Olá! meu nome é Matheus Gonçalves'
...
*/
pessoa.caminhandoQuantosMetros // 23
...
pessoa.apresentacao = function(){
   ...
   var fraseMetros
    ...
    return fraseSexo + pessoa.nome + ', tenho ' + pessoa.idade + fraseIdade +
    ', meu peso é ' + pessoa.peso + ' e, só hoje, eu já caminhei ' +  pessoa.caminhandoQuantosMetros + fraseMetros
}
